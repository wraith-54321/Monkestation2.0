...
/datum/biome/jungleland/barren_rocks
	...
	fauna_density = 0.5
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/random = 33,/mob/living/simple_animal/hostile/asteroid/goliath/beast = 33,/mob/living/simple_animal/hostile/asteroid/goldgrub = 25,/mob/living/simple_animal/hostile/jungleland/skin_twister = 1)
...
/datum/biome/jungleland/dry_swamp
	...
	loose_flora_density = 10
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/goliath/beast = 39,/mob/living/simple_animal/hostile/asteroid/goldgrub = 31,/mob/living/simple_animal/hostile/jungleland/meduracha = 8,/mob/living/simple_animal/hostile/jungleland/skin_twister = 1,/mob/living/simple_animal/hostile/jungleland/mosquito = 13, /mob/living/simple_animal/hostile/jungleland/emeraldspider = 8)
	fauna_density = 0.4
...
/datum/biome/jungleland/toxic_pit
	...
	dense_flora_density = 10
	fauna_types = list(/mob/living/simple_animal/hostile/jungleland/blobby = 20,/mob/living/simple_animal/hostile/jungleland/meduracha = 50,/mob/living/simple_animal/hostile/jungleland/skin_twister = 2,/mob/living/simple_animal/hostile/jungleland/mosquito = 46, /mob/living/simple_animal/hostile/jungleland/emeraldspider = 2)
	fauna_density = 0.7
	spawn_fauna_on_closed = TRUE
...
/datum/biome/jungleland/dying_forest
	...
	fauna_types = list(/mob/living/simple_animal/hostile/asteroid/basilisk/watcher/magmawing = 39,/mob/living/simple_animal/hostile/jungleland/corrupted_dryad = 55,/mob/living/simple_animal/hostile/jungleland/skin_twister = 1,/mob/living/simple_animal/hostile/jungleland/mosquito = 5)
	fauna_density = 0.8
...
/datum/biome/jungleland/jungle
	...
	fauna_types = list(/mob/living/simple_animal/hostile/jungleland/dryad = 65 ,/mob/living/simple_animal/hostile/jungleland/skin_twister = 1,/mob/living/simple_animal/hostile/jungleland/mosquito = 10, /mob/living/simple_animal/hostile/jungleland/yellowjacket = 10, /mob/living/simple_animal/hostile/jungleland/emeraldspider = 14)
	fauna_density = 0.65
