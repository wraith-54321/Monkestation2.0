...
/datum/chewin_cooking/recipe_step/use_tool/New(type, quality, datum/chewin_cooking/recipe/our_recipe)
...
/datum/chewin_cooking/recipe_step/use_tool/check_conditions_met(obj/item/added_item, datum/chewin_cooking/recipe_tracker/tracker)
	if(!initial(added_item.tool_behaviour))
		return CHEWIN_CHECK_INVALID

	return CHEWIN_CHECK_VALID

/datum/chewin_cooking/recipe_step/use_tool/follow_step(obj/added_item, obj/item/reagent_containers/cooking_container/container)
...
/datum/chewin_cooking/recipe_step/use_tool/calculate_quality(obj/added_item)
	var/obj/item/our_tool = added_item
