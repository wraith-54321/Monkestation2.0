...
/datum/map_template/random_room/random_bar/box_base
	...
	mappath = "_maps/RandomBars/Box/default_bar.dmm"
	centerspawner = FALSE
	template_height = 17
	template_width = 11
	weight = 6
...
/datum/map_template/random_room/random_bar/box_base/clockwork
	...
	mappath = "_maps/RandomBars/Box/clockwork_bar.dmm"
	weight = 2

/datum/map_template/random_room/random_bar/box_base/cult
	name = "Cult Bar"
	room_id = "box_cult"
	mappath = "_maps/RandomBars/Box/bloody_bar.dmm"
	weight = 2

/datum/map_template/random_room/random_bar/box_base/vietmoth
	name = "Jungle Bar"
	room_id = "box_vietmoth"
	mappath = "_maps/RandomBars/Box/vietmoth_bar.dmm"
	weight = 12
