/datum/map_template/random_room/random_bar/tramstation_base
	...
	mappath = "_maps/RandomBars/Tram/tram_bar_base.dmm"
	centerspawner = FALSE
	template_height = 25
	template_width = 30
	weight = 8
