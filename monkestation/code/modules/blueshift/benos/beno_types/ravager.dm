...
/datum/action/cooldown/alien/nova/literally_too_angry_to_die/Activate()
	...
	ADD_TRAIT(owner, TRAIT_STUNIMMUNE, XENO_ABILITY_TRAIT)
	ADD_TRAIT(owner, TRAIT_NOSOFTCRIT, XENO_ABILITY_TRAIT)
	ADD_TRAIT(owner, TRAIT_NOHARDCRIT, XENO_ABILITY_TRAIT)
	endure_active = TRUE
	return TRUE
...
/datum/action/cooldown/alien/nova/literally_too_angry_to_die/proc/endure_deactivate()
	...
	REMOVE_TRAIT(owner, TRAIT_STUNIMMUNE, XENO_ABILITY_TRAIT)
	REMOVE_TRAIT(owner, TRAIT_NOSOFTCRIT, XENO_ABILITY_TRAIT)
	REMOVE_TRAIT(owner, TRAIT_NOHARDCRIT, XENO_ABILITY_TRAIT)
