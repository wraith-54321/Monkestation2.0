//range artifacts require stimuli to fall within a range between amount and base trigger amount
...
/datum/artifact_activator/range/heat
	...
	hint_texts = list("It feels like someone messed with the thermostat.", "It feels unpleasant being near.")
...
/datum/artifact_activator/range/radiation
	...
	hint_texts = list("Emits a hum that resembles the Supermatter.", "You swear you saw your bones for a second.")
