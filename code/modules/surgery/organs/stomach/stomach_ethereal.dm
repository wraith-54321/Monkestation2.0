...
/obj/item/organ/internal/stomach/ethereal/on_mob_insert(mob/living/carbon/organ_owner, special, movement_flags)
	. = ..()
...
/obj/item/organ/internal/stomach/ethereal/on_mob_remove(mob/living/carbon/organ_owner, special)
	. = ..()
	...
	organ_owner.clear_mood_event("charge")
