...
/obj/item/organ/internal/appendix/on_mob_remove(mob/living/carbon/organ_owner, special)
	. = ..()
	REMOVE_TRAIT(organ_owner, TRAIT_DISEASELIKE_SEVERITY_MEDIUM, type)
	organ_owner.med_hud_set_status()

/obj/item/organ/internal/appendix/on_mob_insert(mob/living/carbon/organ_owner, special, movement_flags)
	. = ..()
