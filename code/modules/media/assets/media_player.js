(() => {
  var e,
    t = globalThis;
  function n(e, t) {
    let n = `byond://?src=media:href;type=${encodeURIComponent(e)}`;
    (t && (n += `;params=${encodeURIComponent(JSON.stringify(t))}`),
      (window.location.href = n));
  }
  function o(e) {
    (e && console.debug("full_clear:", e),
      audio?.unload(),
      (audio = null),
      (sent_playing = !1),
      (load_time = null),
  ...
  (!(function () {
    ...
    n.prototype = {
      ...
      volume: function (e) {
        var t = this || o;
        if (
          ((e = parseFloat(e)), t.ctx || l(), void 0 !== e && e >= 0 && e <= 1)
        ) {
    ...
    r.prototype = {
      ...
      play: function (e, t) {
        ...
        else if ("string" == typeof e && "loaded" === n._state && !n._sprite[e])
          return null;
        ...
        if (n._webAudio) {
          ...
          if (h.readyState >= 3 || y) v();
          else {
            ((n._playLock = !0), (n._state = "loading"));
            var A = function () {
              ((n._state = "loaded"),
                v(),
                h.removeEventListener(o._canPlayEvent, A, !1));
            };
    ...
    var a = {},
      s = function (e) {
        ...
        if (/^data:[^;]+;base64,/.test(t)) {
          for (
            var n = atob(t.split(",")[1]), o = new Uint8Array(n.length), r = 0;
            r < n.length;
            ++r
          )
            o[r] = n.charCodeAt(r);
    ...
    ("function" == typeof define &&
      ...
      (e = r),
      void 0 !== t
        ? ((t.HowlerGlobal = n), (t.Howler = o), (t.Howl = r), (t.Sound = i))
    ...
    (cleared = !1),
    (sent_playing = !1),
    (window.play = (t, r, i, a = 0, s = 0, u = 0, d = 0) => {
      audio &&
        (audio.unload(),
        (audio = null),
        (sent_playing = !1),
      ...
      try {
        let _ = (window.audio = new e({
            ...
            onplay: () => {
              ((start_time = Date.now()),
                (cleared = !1),
                sent_playing || ((sent_playing = !0), n("playing", { url: t })),
                null !== load_time &&
                  (offset = 2 * Math.ceil((start_time - load_time) / 1e3)),
...
offset=${offset}`));
            ...
            onend: () => o("onend"),
            onloaderror: () => o("onloaderror"),
            onplayerror: () => o("onplayerror"),
          })),
          l = _._sounds;
        if (l)
          for (let e of l) {
            let t = e._node;
            t && (t.crossOrigin = "anonymous");
          }
        ((load_time = Date.now()), _.pos(a, s, u), _.stereo(d), _.play());
      } catch (e) {
        (console.error("Failed to play audio", e), stop());
      }
    }),
    (window.stop = () => {
      o("stop");
    ...
    (window.set_time = (e, t) => {
      (t ||
        !(function (e) {
          if (!start_time || e <= 0 || offset <= 0) return !1;
          let t = (Date.now() - start_time) / 1e3,
            n = Math.abs(t - e);
          return (
...
diff = ${n}`),
    ...
    (window.set_position = (e, t, n) => {
      audio?.pos(e, t, n);
    }),
    (window.set_panning = (e) => {
      audio?.stereo(e || 0);
    }),
    (document.onreadystatechange = () => {
      "complete" === document.readyState && n("ready");
    }));
})();
