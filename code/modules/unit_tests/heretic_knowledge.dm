...
/datum/unit_test/heretic_knowledge/Run()
	...
	var/list/all_possible_knowledge = subtypesof(/datum/heretic_knowledge)
	...
	for(var/datum/heretic_knowledge/knowledge_path as anything in all_possible_knowledge)
		if(knowledge_path::abstract_type == knowledge_path)
			continue
		var/found = FALSE
