...
/datum/heretic_knowledge/curse/on_finished_recipe(mob/living/user, list/selected_atoms,  turf/loc)
	...
	if(IS_MONSTERHUNTER(to_curse))
		to_chat(user, span_boldwarning("As you attempt to lay your curse upon [to_curse.real_name], something otherworldly reaches forth to bite and tears away at your body. Some hidden beast shadows your target!"), type = MESSAGE_TYPE_WARNING)
