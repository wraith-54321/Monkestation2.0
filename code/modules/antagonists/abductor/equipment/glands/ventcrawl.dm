...
/obj/item/organ/internal/heart/gland/ventcrawling/on_mob_insert(mob/living/carbon/organ_owner, special)
	. = ..()
...
/obj/item/organ/internal/heart/gland/ventcrawling/on_mob_remove(mob/living/carbon/organ_owner, special)
	. = ..()
