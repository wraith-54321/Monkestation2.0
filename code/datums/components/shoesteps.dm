...
/datum/component/shoesteps/proc/toggle_sounds(mob/living/carbon/clicker)
	if(!DOING_INTERACTION(clicker, DOAFTER_SOURCE_SHOESTEP_TOGGLE))
		if(do_after(clicker, 1 SECONDS, interaction_key = DOAFTER_SOURCE_SHOESTEP_TOGGLE))
			sounds = !sounds
...
/datum/component/shoesteps/combine_boot_sounds
	custom_sounds = list(
		FOOTSTEP_WOOD = list(list(
			'sound/effects/hl2/footstep/combinewood1.ogg',
			'sound/effects/hl2/footstep/combinewood2.ogg',
			'sound/effects/hl2/footstep/combinewood3.ogg',
			'sound/effects/hl2/footstep/combinewood4.ogg',
			'sound/effects/hl2/footstep/combinewood5.ogg'), 40, 0),
		FOOTSTEP_FLOOR = list(list(
			'sound/effects/hl2/footstep/combine1.ogg',
			'sound/effects/hl2/footstep/combine2.ogg',
			'sound/effects/hl2/footstep/combine3.ogg',
			'sound/effects/hl2/footstep/combine4.ogg',
			'sound/effects/hl2/footstep/combine5.ogg'), 30, -1),
		FOOTSTEP_PLATING = list(list(
			'sound/effects/hl2/footstep/combinemetal1.ogg',
			'sound/effects/hl2/footstep/combinemetal2.ogg',
			'sound/effects/hl2/footstep/combinemetal3.ogg',
			'sound/effects/hl2/footstep/combinemetal4.ogg',
			'sound/effects/hl2/footstep/combinemetal5.ogg'), 30, 1),
		FOOTSTEP_CARPET = list(list(
			'sound/effects/hl2/footstep/combinedirt1.ogg',
			'sound/effects/hl2/footstep/combinedirt2.ogg',
			'sound/effects/hl2/footstep/combinedirt3.ogg',
			'sound/effects/hl2/footstep/combinedirt4.ogg',
			'sound/effects/hl2/footstep/combinedirt5.ogg'), 30, -1),
		FOOTSTEP_SAND = list(list(
			'sound/effects/hl2/footstep/combinedirt1.ogg',
			'sound/effects/hl2/footstep/combinedirt2.ogg',
			'sound/effects/hl2/footstep/combinedirt3.ogg',
			'sound/effects/hl2/footstep/combinedirt4.ogg',
			'sound/effects/hl2/footstep/combinedirt5.ogg'), 30, 0),
		FOOTSTEP_GRASS = list(list(
			'sound/effects/hl2/footstep/combinedirt1.ogg',
			'sound/effects/hl2/footstep/combinedirt2.ogg',
			'sound/effects/hl2/footstep/combinedirt3.ogg',
			'sound/effects/hl2/footstep/combinedirt4.ogg'), 30, 0),
		...
		FOOTSTEP_CATWALK = list(list(
			'sound/effects/hl2/footstep/combinemetalwalkway1.ogg',
			'sound/effects/hl2/footstep/combinemetalwalkway2.ogg',
			'sound/effects/hl2/footstep/combinemetalwalkway3.ogg',
			'sound/effects/hl2/footstep/combinemetalwalkway4.ogg',
			'sound/effects/hl2/footstep/combinemetalwalkway5.ogg'), 40, 1),
		FOOTSTEP_BALL = list(list(
			'sound/effects/ballpit.ogg'), 100, 0),
		)
...
/datum/component/shoesteps/orchestra_hit
	custom_sounds = list(
		FOOTSTEP_WOOD = list(list( // I would like to apologize for this. It was intended as a ohoho joke during development to show off it works
			...
			'sound/effects/artifacts/orchestral/hit18.ogg'), 100, 0),
		FOOTSTEP_FLOOR = list(list(
			'sound/effects/artifacts/orchestral/hit01.ogg',
			'sound/effects/artifacts/orchestral/hit02.ogg',
			'sound/effects/artifacts/orchestral/hit03.ogg',
...
/datum/component/shoesteps/hosboots
	custom_sounds = list(
		FOOTSTEP_WOOD = list(list(
			'sound/effects/bigboot/bigboot1.ogg',
			'sound/effects/bigboot/bigboot2.ogg',
			'sound/effects/bigboot/bigboot3.ogg',
			'sound/effects/bigboot/bigboot4.ogg',
			'sound/effects/bigboot/bigboot5.ogg',), 40, 2),
		FOOTSTEP_FLOOR = list(list(
			'sound/effects/bigboot/bigboot1.ogg',
			'sound/effects/bigboot/bigboot2.ogg',
			'sound/effects/bigboot/bigboot3.ogg',
...
/datum/component/shoesteps/tap_shoes
	custom_sounds = list(
		FOOTSTEP_WOOD = list(list(
			'sound/effects/tapshoes/tapwood1.ogg',
			'sound/effects/tapshoes/tapwood2.ogg',
			'sound/effects/tapshoes/tapwood3.ogg',
			'sound/effects/tapshoes/tapwood4.ogg',), 45, 0),
		FOOTSTEP_FLOOR = list(list(
			'sound/effects/tapshoes/tapmetal1.ogg',
			'sound/effects/tapshoes/tapmetal2.ogg',
			'sound/effects/tapshoes/tapmetal3.ogg',
			'sound/effects/tapshoes/tapmetal4.ogg',), 12, -1),
		FOOTSTEP_PLATING = list(list(
			'sound/effects/tapshoes/plateB1.ogg',
			'sound/effects/tapshoes/plateB2.ogg',
			'sound/effects/tapshoes/plateB3.ogg',
			'sound/effects/tapshoes/plateB4.ogg',), 36, 1),
		FOOTSTEP_CARPET = list(list(
			'sound/effects/tapshoes/tapcarpet1.ogg',
			'sound/effects/tapshoes/tapcarpet2.ogg',
			'sound/effects/tapshoes/tapcarpet3.ogg',
			'sound/effects/tapshoes/tapcarpet4.ogg',), 95, -1),
		FOOTSTEP_SAND = list(list(
			'sound/effects/tapshoes/tapsand1.ogg',
			'sound/effects/tapshoes/tapsand2.ogg',
			'sound/effects/tapshoes/tapsand3.ogg',
			'sound/effects/tapshoes/tapsand4.ogg',), 75, 0),
		FOOTSTEP_GRASS = list(list(
