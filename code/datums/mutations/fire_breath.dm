/datum/mutation/firebreath
	...
	conflicts = list(/datum/mutation/firebreath/unstable)

/datum/mutation/firebreath/unstable
	...
	instability = 50
	conflicts = list(/datum/mutation/firebreath)
...
/datum/mutation/firebreath/setup()
	...
	to_modify.synchronized = GET_MUTATION_SYNCHRONIZER(src)
...
/datum/action/cooldown/spell/cone/staggered/fire_breath/before_cast(atom/cast_on)
	...
	our_lizard.adjust_fire_stacks(cone_levels * synchronized)
