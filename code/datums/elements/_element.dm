...
/**
 * Used to manage elements with multiple sources through traits.
 * The element is detached once the last trait source is removed.
 */
/datum/proc/AddElementTrait(trait, source, datum/element/eletype, ...)
	if(!ispath(eletype, /datum/element))
		CRASH("AddElementTrait called, but [eletype] is not a /datum/element path.")
