...
/datum/brain_trauma/special/death_whispers/on_life(seconds_per_tick, times_fired)
	..()
...
/datum/brain_trauma/special/beepsky/on_life(seconds_per_tick, times_fired)
	...
	if(get_dist(owner, beepsky) >= 10 && SPT_PROB(10, seconds_per_tick))
		create_securitron()
	...
	if(SPT_PROB(10, seconds_per_tick) && get_dist(owner, beepsky) <= 8)
...
/obj/effect/client_image_holder/securitron/process(seconds_per_tick)
